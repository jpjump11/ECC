...
1. `~/.local/share/ecc-homunculus/instincts/`からすべてのinstinctsを読み取る
...
3. 3以上の関連instinctsの各クラスターに対して:
   ...
   - 適切なファイルを生成
   - `~/.local/share/ecc-homunculus/evolved/{commands,skills,agents}/`に保存
...
作成: /new-tableコマンド
ファイル:
  - ~/.local/share/ecc-homunculus/evolved/commands/new-table.md
...
ファイル:
  - ~/.local/share/ecc-homunculus/evolved/skills/functional-patterns.md
...
作成: debuggerエージェント
ファイル:
  - ~/.local/share/ecc-homunculus/evolved/agents/debugger.md
