...
| Evolved | `~/.local/share/ecc-homunculus/evolved/skills/` (global) or `projects/<hash>/evolved/skills/` (per-project) | No | Inherits from instinct source |
...
Location: `~/.local/share/ecc-homunculus/evolved/skills/` (global) or `~/.local/share/ecc-homunculus/projects/<hash>/evolved/skills/` (per-project).
...
| | `~/.local/share/ecc-homunculus/**/evolved/**` |
